...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:teal;font-family: 'raleway', cursive;font-size:2.2em;padding:3%;">Transfer Record</h3>
    <table id="myTable" >
          <tr>
          ...
          <?php
        $sql = "SELECT * FROM `transfer` ORDER BY
transfer_id ";
